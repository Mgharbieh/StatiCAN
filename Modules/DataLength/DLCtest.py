...
### FILE PATH TO THE GITHUB FOLDER TITLED 'DataLength'                        ###
### Should be something along the line of:                                    ###
### {SAVE_LOCATION}/CAN-Static-AnalysisSrc/AnalysisSrc/DataLength/Test_Cases/ ###
        ...
        if(item[:5] == "test_"):
            ...
            for file in os.listdir(path1):
                if(file[-4:] == '.ino' or file[-4:] == '.cpp'):
                    ...
                    issues, messages, line_nums = analyzer.checkDLC(root)
                    print()
